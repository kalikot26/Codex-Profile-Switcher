...
- [`aisw`](https://www.npmjs.com/package/aisw) CLI — the account/credential backend (recommended edition)
- [`codex-profiles`](https://github.com/midhunmonachan/codex-profiles) Rust CLI — backend for the legacy edition (bundled, MIT © Midhun Monachan)

## ⭐ Which edition should I use?

This repo holds three generations. **Use the aisw edition** unless you have a reason not to.

| Edition | Folder | Backend | Status |
|---------|--------|---------|--------|
| ⭐ **KalikotAISW** | [`kalikot-aisw/`](kalikot-aisw/) | `aisw` | **Recommended — current, best version** |
| KalikotProfileSwitcher | [`gui/`](gui/) | `codex-profiles` | Legacy — kept for reference |
| KaliClaude | [`kalikot-claude/`](kalikot-claude/) | `aisw` (Claude) | Experimental — Claude account variant |
...
- The bundled [`codex-profiles`](https://github.com/midhunmonachan/codex-profiles)
  Rust CLI ([`src/`](src/), [`tests/`](tests/)) is MIT-licensed work by Midhun
  Monachan; all credit for that CLI goes to the upstream project.
